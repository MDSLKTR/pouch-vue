...
interface PouchAPI {
    ...
    query(
        ...
        db?: string
    ): Promise<PouchDB.Query.Response<{}>>;
    find(
    ...
    allDocs(
        ...
        db?: string
    ): Promise<PouchDB.Core.AllDocsResponse<{}>>;
    bulkDocs(
        docs: PouchDB.Core.PutDocument<{}>[],
        options?: PouchDB.Core.BulkDocsOptions,
        db?: string
    ): Promise<(PouchDB.Core.Response | PouchDB.Core.Error)[]>;
    compact(
        options?: PouchDB.Core.CompactOptions,
        db?: string
    ): Promise<PouchDB.Core.Response>;
    ...
    deleteAttachment(
        docId: PouchDB.Core.DocumentId,
        attachmentId: PouchDB.Core.AttachmentId,
        docRev: PouchDB.Core.RevisionId,
        db?: string
